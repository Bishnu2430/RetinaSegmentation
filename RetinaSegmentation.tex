...
{\normalsize (Professor, Department of Computer Science and Engineering)}\\
\vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=1.2\linewidth]{FlowChart_HD.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.6\linewidth]{ode_unet_results/training_performance.png}
